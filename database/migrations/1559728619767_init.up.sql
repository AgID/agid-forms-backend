...
ALTER TABLE ONLY public.node_revision
    ADD CONSTRAINT node_revision_language_fkey FOREIGN KEY (language) REFERENCES public.language(language) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.node_revision
    ADD CONSTRAINT node_revision_status_fkey FOREIGN KEY (status) REFERENCES public.status(status) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.node_revision
    ADD CONSTRAINT node_revision_user_id_fkey FOREIGN KEY (user_id) REFERENCES public."user"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public.node
